...
<input type="submit" value="" onclick = "location='/correo'" style="background-image: url('{{asset('assets/img/botonGuardarContenido.png')}}'); 
                background-size: contain; 
                height: 45px; width: 239px;margin-left: 750px;margin-bottom: 0px; margin-top: 20px;"  >
<textarea style="position: relative;left: 750px;top: -310px; width: 300px;height: 200px; resize: none;"> </textarea>
